...
if mult_int > comp_item:
    print('Переменная ' + str(mult_int) + ' больше', comp_item)
...
if div_int < comp_item:
    print('Переменная ' + str(div_int) + ' меньше', comp_item)
...
if item_1 < comp_item:
    print('Переменная ' + str(item_1) + ' меньше', comp_item)
else:
    print('Переменная ' + str(item_1) + ' больше или равна', comp_item)
...
if item_2:
    print('Переменная ' + str(item_2) + ' =', item_2)
else:
    print('Переменная ' + str(item_2) + ' =', item_3)
...
if item_3:
    print('Переменная ' + str(item_3) + ' =', item_2)
else:
    print('Переменная ' + str(item_3) + ' =', item_3)
...
if item_5:
    print('Переменная ' + str(item_5) + ' =', item_5)
else:
    print('Переменная ' + str(item_5) + ' =', item_4)
...
if item_4:
    print('Переменная ' + str(item_4) + ' =', item_5)
else:
    print('Переменная ' + str(item_4) + ' =', item_4)


# 29) Создать переменную currency_convertor со значением item_2
currency_convertor = item_2

# 30) Сделать if в котором будет условие: если currency_convertor, то выполнять следующие шаги задания, иначе,
